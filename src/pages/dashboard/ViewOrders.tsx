...
//             const url = filter === "" ? "order-mgt/get-all-orders" : (filter in urls ? urls[filter as FilterType] : "");
...
//         activeOrder && setCurrentOrder(activeOrder);
...
//                 };
//             }
//             return prevState; // Return previous state if prevState is null
//         });
//     };

//     const updateOrderStatus = useCallback(async(e:React.FormEvent<HTMLFormElement>) =>{
//         e.preventDefault();

//         if(currentOrder){
//             const url = `order-mgt/update-order-status/${currentOrder.id}`;
...
//                         select={[{key: "all_orders", value: "get all orders"},
...
//                 <tr>
//                     <th scope="col" className="px-2 py-2 sm:px-4 sm:py-4">Order No</th>
//                     <th scope="col" className="px-2 py-2 sm:px-4 sm:py-4">Date</th>
//                     <th scope="col" className="px-2 py-2 sm:px-4 sm:py-4">Customer Name</th>
//                     <th scope="col" className="px-2 py-2 sm:px-4 sm:py-4">Email</th>
//                     <th scope="col" className="px-2 py-2 sm:px-4 sm:py-4">Price</th>
//                     <th scope="col" className="px-2 py-2 sm:px-4 sm:py-4">Status</th>
//                     <th scope="col" className="px-2 py-2 sm:px-4 sm:py-4">Action</th>
//                 </tr>
//             </thead>
...
//                         <Notification
//                             type={notificationType[order?.status].type}
//                             message={notificationType[order?.status].message}
...
//                     <Button 
//                         size= "small"
//                         className="text-white text-sm lg:text-base font-medium flex justify-center gap-2"
//                     >
...
//                     <Button 
//                         size= "small"
//                         className="text-white text-sm lg:text-base font-medium flex justify-center gap-2 px-6"
//                     >
//                         Next
...
//                         </p>
//                         <p className="text-sm text-normal first-letter:uppercase">
...
//                         </p>
//                         <p className="text-sm text-normal capitalize">
//                             {currentOrder?.items && (currentOrder?.items.reduce((total, item) =>{
...
//                 <button 
//                     type="submit"
//                     className="w-full py-3 text-white bg-black font-bold text-size-500 "
//                 >
//                     Update order status
//                 </button>
//             </form>
